...
{- We use a DIY Equality module for now to show how the tools for step
   by step equational reasoning work. In case of unexpected behaviour:
   import Relation.Binary.PropositionalEquality as Eq instead. -}
...
[[https://plfa.github.io/Induction/][Programming Language Foundations in Agda Chapter 2. on Induction]]
